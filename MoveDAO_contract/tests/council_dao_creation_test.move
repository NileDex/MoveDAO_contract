...
module movedaoaddrx::council_dao_creation_test {
    ...
    public entry fun test_council_dao_creation_lifecycle(
        ...
        dao_core::init_registry_for_test();
    ...
    #[expected_failure(abort_code = 602, location = movedaoaddrx::dao_core_file)]
    ...
    #[expected_failure(abort_code = 601, location = movedaoaddrx::dao_core_file)]
