...
module movedaoaddrx::council_dao_creation_test {
    ...
    #[expected_failure(abort_code = 602, location = movedaoaddrx::dao_core_file as dao_core)]
    ...
    #[expected_failure(abort_code = 601, location = movedaoaddrx::dao_core_file as dao_core)]
